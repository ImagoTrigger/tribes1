...
var dataelem = "#consolelog";
var pausetoggle = "#pause";
var scrollelems = ["html", "body"];

var url = "/console/console.log";
var fix_rn = true;
...
function show_log() {
    ...
    var t_a = t.split(/\n/g);
    var arrayLength = t_a.length;
    for (var i = 0; i < arrayLength; i++) {
        var n = t_a[i].indexOf("Error");
        if (n >= 0) {
            t_a[i] = "<font color=red>"+t_a[i]+"</font><br/>\n";
        } else {
            t_a[i] = "<font color=black>"+t_a[i]+"</font><br/>\n";
        }
    }
    t = t_a.join("\n");
